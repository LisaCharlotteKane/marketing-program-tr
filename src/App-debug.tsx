          ...
          <Tabs defaultValue="test" className="w-full">
            ...
            <TabsContent value="test">
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold tracking-tight">Component Test</h2>
            ...
            <TabsContent value="planning">
              <div className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Campaign Planning Features</CardTitle>
                    <CardDescription>
                      Full campaign planning functionality will be restored here
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground">
                      Campaign manager component will be loaded here once testing is complete.
                    </p>
                  </CardContent>
                </Card>
              </div>
            ...
            <TabsContent value="execution">
              <div className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Execution Tracking Features</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground">
                      Execution tracking component will be loaded here once testing is complete.
                    </p>
                  </CardContent>
                </Card>
              </div>
            ...
            <TabsContent value="reporting">
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      Reporting dashboard component will be loaded here once testing is complete.
                    </p>
                  </CardContent>
                </Card>
              </div>
            ...
            <TabsContent value="calendar">
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      Campaign calendar component will be loaded here once testing is complete.
                    </p>
                  </CardContent>
                </Card>
              </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <Alert>
                      <Target className="h-4 w-4" />
                      <AlertDescription>
                        <strong>System Test Mode:</strong> Testing core components and functionality. 
                        Full features will be restored once testing is complete.
                      </AlertDescription>
                    </Alert>
                  </CardContent>
                </Card>
